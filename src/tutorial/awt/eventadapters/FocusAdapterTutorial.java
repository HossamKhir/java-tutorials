 ...
 *
 */
public class FocusAdapterTutorial extends FocusAdapter {
	...
	public static void main(String[] args){
		FocusAdapterTutorial  focusAdapterTutorial = new FocusAdapterTutorial();        
		focusAdapterTutorial.showFocusAdapterDemo();
	}
